...
"""
Скрипт для опускания руки робота RM 001.
"""
...
def init_device():
    ...
    try:
        ...
        print("Использование: move_down.py -d <i2c_adapter_name>")
        sys.exit(2)
...
def start():
    """
    Запускает программу опускания руки.
    ...
    # Опускаем руку робота
    errCode, errText = move_down()
    if errCode != 0:
        return errCode, errText
...
def main():
    ...
    """
    print("Запуск робота RM 001 - опускание руки")
