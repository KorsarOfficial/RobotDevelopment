...
"""
Скрипт для поворота робота RM 001 вправо.
"""
...
def init_device():
    ...
    try:
        ...
        print("Использование: move_right.py -d <i2c_adapter_name>")
        sys.exit(2)
...
def start():
    """
    Запускает программу поворота вправо.
...
def main():
    ...
    """
    print("Запуск робота RM 001 - поворот вправо")
