...
"""
Скрипт для поворота робота RM 001 влево.
"""
...
def init_device():
    ...
    try:
        ...
        print("Использование: move_left.py -d <i2c_adapter_name>")
        sys.exit(2)
...
def start():
    """
    Запускает программу поворота влево.
...
def main():
    ...
    """
    print("Запуск робота RM 001 - поворот влево")
